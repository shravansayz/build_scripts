...
git clone https://github.com/shravansayz/local_manifests.git --depth 1 -b vol .repo/local_manifests && \
/opt/crave/resync.sh && \
export BUILD_USERNAME=shravan && \
export BUILD_HOSTNAME=crave && \
export TZ=Asia/Kolkata && \
wget https://github.com/shravansayz/local_manifests/raw/keys/keys.zip && unzip -o keys.zip -d vendor/voltage-priv/ && rm keys.zip && \
